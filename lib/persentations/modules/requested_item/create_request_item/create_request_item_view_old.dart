...
class CreateRequestItemViewOld extends StatefulWidget {
  const CreateRequestItemViewOld({super.key});

  @override
  State<CreateRequestItemViewOld> createState() => _CreateRequestItemViewOldState();
}

class _CreateRequestItemViewOldState extends State<CreateRequestItemViewOld> {
      ...
      child: CustomButton(
        ...
        onPressed: () {
          if (productFormKey.currentState!.validate()) {
            onAddProduct(
              RequestProductParam(productId, productName, int.parse(_qtyController.text), _unitController.text, '', ''),
            );
          }
        },
      ),
